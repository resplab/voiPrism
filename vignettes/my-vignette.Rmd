...
```{r}
model_run(model_name="voi", api_key='aaHYJJb4hcrmBYY3', model_input = list(outputs = outputs_cea, inputs = inputs, pars="p1", func="evppi"))
model_run(model_name="voi", api_key='aaHYJJb4hcrmBYY3', model_input = list(outputs = outputs_nb, inputs = inputs, pars=c("p1","p2"), func="evppi"))
```
...
```{r}
model_run(model_name="voi", api_key='aaHYJJb4hcrmBYY3', model_input = list(outputs = outputs_cea, inputs = inputs, pars=list("p1",c("p1","p2")), func="evppi"))
```
...
```{r}
model_run(model_name="voi", api_key='aaHYJJb4hcrmBYY3', model_input = list(outputs = outputs_nb, inputs = inputs, pars="p1", nsim=1000, func="evppi", method="gp"))
```
...
```{r}
model_run(model_name="voi", api_key='aaHYJJb4hcrmBYY3', model_input = list(outputs = outputs_nb, inputs = inputs, pars="p1", func="evppi", method="earth"))
```
...
```{r,eval=FALSE}
model_run(model_name="voi", api_key='aaHYJJb4hcrmBYY3', model_input = list(outputs = outputs_nb, inputs = inputs, pars=c("p1","p2"), func="evppi", method="inla"))
```
...
```{r}
model_run(model_name="voi", api_key='aaHYJJb4hcrmBYY3', model_input = list(outputs = outputs_nb, inputs = inputs, pars=c("p1","p2"), gam_formula="s(p1) + s(p2)", func="evppi", method="gam"))
```
...
```{r}
model_run(model_name="voi", api_key='aaHYJJb4hcrmBYY3', model_input = list(outputs = outputs_nb, inputs = inputs, pars="p1", se=TRUE, B=100, func="evppi"))
```
...
```{r}
model_run(model_name="voi", api_key='aaHYJJb4hcrmBYY3', model_input = list(outputs = outputs_nb, inputs = inputs, pars="p1", etc = list(n.blocks=20), func="evppi", method="so"))
```

The method of [Sadatsafavi et al.](https://doi.org/10.1016/j.jval.2012.10.018):

```{r}
model_run(model_name="voi", api_key='aaHYJJb4hcrmBYY3', model_input = list(outputs = outputs_nb, inputs = inputs, pars="p1", func="evppi", method="sal"))
```
...
```{r,eval=FALSE}
model_run(model_name="voi", api_key='aaHYJJb4hcrmBYY3', model_input = list(model_fn = model_fn_nb, par_fn = par_fn, pars="p1", func="evppi_mc", ninner=1000, nouter=100))
```
...
model_run(model_name="voi", api_key='aaHYJJb4hcrmBYY3', model_input = list(model_fn = model_fn_nb, par_fn = par_fn_corr, pars="p1", func="evppi_mc", ninner=1000, nouter=100))
```
...
set.seed(1)
model_run(model_name="voi", api_key='aaHYJJb4hcrmBYY3', model_input = list(outputs = outputs_nb, inputs = inputs, datagen_fn = datagen_normal, n=c(10,100,1000), func="evsi"))
```
...
```{r}
model_run(model_name="voi", api_key='aaHYJJb4hcrmBYY3', model_input = list(outputs = outputs_nb, inputs = inputs, pars="p1", study = "normal_known", n=c(100,1000), func="evsi"))
model_run(model_name="voi", api_key='aaHYJJb4hcrmBYY3', model_input = list(outputs = outputs_cea, inputs = inputs, datagen_fn = datagen_normal, n=c(10,100,1000), func="evsi"))
```
...
model_run(model_name="voi", api_key='aaHYJJb4hcrmBYY3', model_input = list(outputs = outputs_nb, inputs = inputs, pars="p1", datagen_fn = datagen_normal, likelihood = likelihood_normal, n=100, func="evsi", method="is", nsim=1000))
```
...
```{r}
model_run(model_name="voi", api_key='aaHYJJb4hcrmBYY3', model_input = list(outputs = outputs_nb, inputs = inputs, pars="p1",study = "normal_known", n=100, func="evsi", method="is", nsim=1000))
```
...
```{r}
model_run(model_name="voi", api_key='aaHYJJb4hcrmBYY3', model_input = list(outputs = p2, inputs = inputs, study = "binary", pars = "p1", func="evsivar", n=c(100,1000,10000)))
```
...
model_run(model_name="voi", api_key='aaHYJJb4hcrmBYY3', model_input = list(outputs = p2, inputs = inputs_p2, study = "binary", pars = "p1", func="evsivar", n=c(100,1000,10000)))
```
